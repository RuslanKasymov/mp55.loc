        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
              	...
              	<div class="col-sm-4 m-b_50">
					<div class="text-center">
                        <img src="/assets/theme/images/ab_comp_logo.png" alt="логотип">
                    </div>
				</div>
				<div class="col-sm-8">
					<p class="about_company_text">Мы стали одним из ведущих магазинов, предлагающих своим покупателям прицепы для легковых автомобилей в Омске и Омской области. Все прицепы изготовлены по современным технологиям и отвечают требованиям наших клиентов. Позвоните нам, и мы поможем подобрать прицеп под Ваши нужды</p>
				</div>
				<div class="col-12">
